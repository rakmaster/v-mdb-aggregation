...
export type AggregationStage = AddFieldsStage | BucketStage | BucketAutoStage | ChangeStreamStage | ChangeStreamSplitLargeEventStage | CollStatsStage | CountStage | CurrentOpStage | DensifyStage | DocumentsStage | FacetStage | FillStage | GeoNearStage | GraphLookupStage | GroupStage | IndexStatsStage | LimitStage | ListLocalSessionsStage | ListSessionsStage | LookupStage | MatchStage | MergeStage | OutStage | PlanCacheStatsStage | ProjectStage | RedactStage | ReplaceRootStage | ReplaceWithStage | SampleStage | SearchStage | SearchMetaStage | SetStage | SetWindowFieldsStage | ShardedDataDistributionStage | SkipStage | SortStage | SortByCountStage | UnionWithStage | UnsetStage | UnwindStage;
